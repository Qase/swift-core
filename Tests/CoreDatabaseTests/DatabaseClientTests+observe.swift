...
private extension DatabaseClientTests {
  func test_observe_single_Job_entity() {
    ...
    var updatedDomainTestModel = domainTestModel
    updatedDomainTestModel.name = "changed-test-model-name"
  ...
  func test_observe_multiple_Job_entities() {
    ...
    var updatedTestModel2 = domainTestModel2
    updatedTestModel2.name = "changed-test-model-2"
